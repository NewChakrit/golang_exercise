...
func main() {
	...
	// A "Select" statement choose which of a set of possible send or receive operations will proceed.
	// It looks similar to a "switch" statement but with the vases all referring to communication operations.
